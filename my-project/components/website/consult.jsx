  ...
  return (
    <div className="flex flex-col gap-4 md:gap-8 lg:flex-row bg-white p-6 md:p-12 lg:px-28 lg:py-10 xl:px-40  ">
      <div className="flex-1 flex flex-col gap-2 md:gap-4 lg:py-10">
        ...
        <div>
          <button className="bg-orange text-white px-8 py-2 text-xs md:text-xl lg:text-sm xl:text-base font-light">
            Contact Us
          </button>
        </div>
      </div>
      <div className="flex-1 border border-slate-400 p-3 md:p-8 lg:p-8 border-4">
        ...
        <p className="text-xs md:text-xl lg:text-xs xl:text-sm font-extralight">
        ...
        <div>
          <div className="flex gap-2 md:gap-4 lg:gap-2 items-center py-5">
            ...
            <div className="flex flex-col ">
              <p className="text-tiny md:text-xl lg:text-xs xl:text-sm font-extralight">
                Call Us On:
              </p>
              <p className="text-tiny md:text-xl lg:text-xs xl:text-sm font-semibold">
                562-456-3016
              </p>
            </div>
          </div>
