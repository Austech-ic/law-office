    ...
    <div className="p-10 md:p-20 lg:p-20 xl:p-32 bg-green text-white">
      <div className="flex flex-col lg:flex-row gap-4">
        <div className="flex-[0.5] flex flex-col gap-2 md:gap-3 ">
          ...
          <div>
            <p className="text-xs md:text-xl lg:text-sm font-light">
              Alpha Advocate Law Group PC is located in Cerritos, CA and serves
              clients in and around Cerritos, Artesia, Hawaiian Gardens,
              Norwalk, Bellflower, Santa Fe Springs, Paramount, Pico Rivera,
              South Gate, Lynwood, Long Beach, Hacienda Heights, Bell, Whittier
              and Compton.
            </p>

            <p className="text-xs md:text-xl lg:text-sm font-light pt-5">
            ...
            <p className="text-xs md:text-xl lg:text-sm font-light pt-5">
              See our profiles at{' '}
              <span className="text-orange underline">Lawyers.com</span> and{' '}
              <span className="text-orange underline">Martindale.com.</span>
            </p>
          </div>
        </div>
        <div className="flex-1 grid lg:grid-cols-3 gap-4 md:gap-8 lg:gap-1 ">
          <div className=" flex-1 flex flex-col gap-2 md:gap-3 lg:gap-2">
            <p className="text-base md:text-2xl lg:text-base xl:text-lg font-bold">
              Links
            </p>
            <Link href={`/`}>
              <p className="text-xs md:text-xl lg:text-sm  font-light">
          ...
          <div className=" flex-1 flex flex-col gap-2 md:gap-3 lg:gap-2">
            <p className="text-sm md:text-2xl lg:text-base xl:text-lg font-bold">
              Contact Us
            </p>
          ...
          <div className="flex-1  flex flex-col gap-2 md:gap-3 lg:gap-2">
            <p className="text-xs md:text-xl lg:text-sm xl:text-base font-bold">
              Practice Areas
            </p>
            <div>
              <p className="text-xs md:text-xl lg:text-sm font-light">
                Landlord-Tenant Law For Owners.
              </p>
            </div>
            <div>
              <p className="text-xs md:text-xl lg:text-sm  font-light">
      ...
      <div className="pt-[33px] md:pt-[50px] lg:pt-[100px]">
        <ul className="flex flex-col lg:flex-row lg:items-center justify-center gap-2 lg:gap-4">
          ...
          <Link href={`/attorneyprofile`} className="hover:text-orange">
            <div className="flex items-center gap-1">
              <li className="text-xs md:text-xl lg:text-sm">
                Attorney Profile
              </li>
            </div>
          </Link>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-2">
          <p className="text-center text-xs md:text-xl lg:text-sm lg:text-start">
            Copyright © 2024 MH Sub I, LLC. All rights reserved.
          </p>
          <div className="flex items-center gap-2">
