  ...
  return (
    <div className='p-10 md:p-20 lg:p-20 xl:p-32 bg-gray'>
       <div className='p-5 md:p-10'>
        <p className='text-xl md:text-5xl lg:text-4xl xl:text-5xl  text-center'>Client <span className='text-orange'>Testimonials</span></p>
        </div>
          ...
          <div>
            ...
            details.map((datum) => (
             ...
             <div className='flex flex-row'>
              ...
              <p className='text-xs md:text-lg lg:text-base xl:text-lg font-light text-center w-[90%] md:w-[80%] lg:w-[80%]'>{datum.desc}</p>
