  ...
  const details = [
    {
      ...
      button: (
        <Link href={`/renter`}>
          <button className="border border-orange px-4 py-2 md:px-8 md:py-4 lg:py-2 bg-transparent text-orange text-xs md:text-xl lg:text-base xl:text-lg">
            Learn More
          </button>
        </Link>
      ),
    ...
    <div className="p-10 md:p-20 lg:p-20 xl:p-32">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        {details.map((datum) => (
          <div
            key={datum.id}
            className="border border-gray flex flex-col items-center p-5 md:p-10 lg:p-5 gap-4 md:gap-6 shadow-md"
          >
            <Image
              src={datum.pic}
              alt="pic-img"
            ...
            />
            <p className="text-center  text-sm md:text-2xl lg:text-base xl:text-lg md:h-[5vh] lg:h-[7vh] font-medium">
              {datum.label}
            </p>
