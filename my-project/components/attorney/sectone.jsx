      ...
      <div className="text-white flex flex-col lg:flex-row gap-8 md:gap-16 lg:gap-8 xl:gap-16 mt-10 md:mt-20">
        <div className="flex-1 flex flex-col gap-2 md:gap-5 lg:gap-2 xl:gap-2">
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <p className="text-orange text-sm md:text-2xl lg:text-base xl:text-lg">
              Welcome to
            </p>
          </div>

          <p className="text-xl md:text-5xl lg:text-3xl xl:text-4xl leading-tight md:leading-tight lg:leading-tight xl:leading-tight ">
            {' '}
            Alpha Advocate Law Group PC
          </p>
          <p className="text-sm md:text-2xl lg:text-lg xl:text-xl leading-6 md:leading-10 lg:leading-7 xl:leading-9 font-light">
            At Alpha Advocate Law Group PC, we are a team of dedicated and
            experienced attorneys committed to providing exceptional legal
            representation to our clients. With a comprehensive understanding of
            the law and a passion for justice, we strive to protect the rights
            and interests of individuals and businesses across a wide range of
            practice areas.
          </p>
          ...
          <div className="lg:mt-3 xl:mt-8">
            <button className="bg-orange text-white text-xs md:text-xl lg:text-base xl:text-lg px-[15px] py-[10px] md:px-8 md:py-4">
              Get An Appointment
            </button>
          </div>
        </div>
