...
const Ownersectone = () => {
  return (
    ...
    <div className='text-white flex items-center justify-center pt-16 md:pt-28 lg:pt-24 xl:pt-40'>
        <p className='text-xl md:text-4xl lg:text-4xl xl:text-5xl '>Landlord-Tenant Law For Owners</p>
    </div>
    <div className='text-white flex flex-col lg:flex-row items-center justify-center py-5 md:py-10 gap-1 md:gap-2 '>
        ...
        <Link href={`/owner`} >
            <p className='text-xs md:text-2xl lg:text-lg xl:text-xl font-light '>Landlord-Tenant Law For Owners</p>
        </Link>
    </div>
</div>
  )
